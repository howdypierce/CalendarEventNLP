...
def next_monthday(day_num: int) -> date:
    ...
    # it's next month
    if today.month == 12:
        return date(today.year + 1, 1, day_num)
...
testdata = [
    ...
    ("Birthday party from midnight to noon on March fourth",
     next_day(3, 4), next_day(3, 4), time(0), time(12), "Birthday party",
     None),
    ...
    ("Vacation 7/2-7/13",
     next_day(7, 2), next_day(7, 2) + timedelta(days=11), None, None,
     "Vacation", None),
    ...
    ("Vacation October 2 thru October 9",
     next_day(10, 2), next_day(10, 2)+timedelta(days=7), None, None,
     "Vacation", None),
